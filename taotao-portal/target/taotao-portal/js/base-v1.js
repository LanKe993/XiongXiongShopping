 ...
 */
function login() {
    return location.href = "http://sso.lvhaotnt.top/page/login";
//    return location.href = "http://localhost:8084/page/login";
}
function regist() {
    return location.href = "http://sso.lvhaotnt.top/page/register";
...
//    var b = "http://localhost:8082/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
    var b = "http://www.lvhaotnt.top/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
