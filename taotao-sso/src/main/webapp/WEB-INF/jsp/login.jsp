...
<div class="w">
    <div id="logo">
    	<a href="http://www.lvhaotnt.top" clstag="passport|keycount|login|01">
    		<img src="/images/taotao-logo.gif" alt="熊熊" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						if (redirectUrl == "") {
							location.href = "http://www.lvhaotnt.top";
						} else {
